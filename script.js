...
class Shopping {
    constructor(title, price, image, size,) {
        this.image = image;
        this.title = title;
        this.price = price;
        this.size = size;
...
class UI {
    ...
    addToCart(shopping) {
        ...
        <div class="row align-items-center text-white-50">
            ...
            <div class="col-md-2">
                <div class="card-text">${shopping.price}</div>
            </div>
            <div class="col-md-2">
                <div class="form-select">${shopping.size}</div>
            </div>
            <div class="col-md-1">
...
for (let i = 0; i < card.length; i++) {
    btnAdd[i].addEventListener("click", function (e) {
        ...
        let size = card[i].getElementsByClassName("form-select")[0].value;
        btnAdd[i].textContent = "Sepete Eklendi";
        let shopping = new Shopping(title, price, image, size);
        let ui = new UI();
